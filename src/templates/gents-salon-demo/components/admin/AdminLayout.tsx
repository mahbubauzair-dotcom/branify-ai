...
export const AdminLayout: React.FC<AdminLayoutProps> = ({
  ...
  const navItems = [
    { label: 'Dashboard', route: '/template/gents-salon-demo/admin' as AdminRoute, icon: LayoutDashboard },
    { label: 'Appointments', route: '/template/gents-salon-demo/admin/appointments' as AdminRoute, icon: CalendarCheck },
    { label: 'Services & Prices', route: '/template/gents-salon-demo/admin/services' as AdminRoute, icon: Scissors },
    { label: 'Offers', route: '/template/gents-salon-demo/admin/offers' as AdminRoute, icon: Tag },
    { label: 'Gallery', route: '/template/gents-salon-demo/admin/gallery' as AdminRoute, icon: ImageIcon },
    { label: 'Reviews', route: '/template/gents-salon-demo/admin/reviews' as AdminRoute, icon: Star },
    { label: 'Settings', route: '/template/gents-salon-demo/admin/settings' as AdminRoute, icon: Settings },
  ];
  ...
  const handleLogout = async () => {
    await logoutAdmin();
    onNavigate('/template/gents-salon-demo/admin/login');
  };
