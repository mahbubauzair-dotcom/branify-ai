...
export const PremiumGroomingSection: React.FC<PremiumGroomingSectionProps> = ({
  ...
  return (
    <section className="py-20 bg-stone-950 relative overflow-hidden border-b border-stone-800">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-zinc-600/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-zinc-500/10 border border-zinc-500/30 text-zinc-400 text-xs font-semibold uppercase tracking-wider mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {premiumServices.map((service) => (
            <div
              key={service.id}
              className="bg-stone-900/90 rounded-2xl border border-stone-800 hover:border-zinc-500/50 overflow-hidden transition-all duration-300 flex flex-col justify-between group shadow-xl"
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-3 right-3 bg-stone-950/90 backdrop-blur-md border border-zinc-500/40 px-2.5 py-1 rounded-full text-xs font-bold text-zinc-400">
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                ...
                <div className="space-y-3 pt-3 border-t border-stone-800">
                  <button
                    ...
                    className="w-full text-center text-xs text-zinc-400 hover:underline font-medium"
                  >
