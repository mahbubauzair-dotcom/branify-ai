...
export type AdminRoute = 
  | '/template/gents-salon/admin'
  | '/template/gents-salon/admin/login'
  | '/template/gents-salon/admin/appointments'
  | '/template/gents-salon/admin/services'
  | '/template/gents-salon/admin/offers'
  | '/template/gents-salon/admin/gallery'
  | '/template/gents-salon/admin/reviews'
  | '/template/gents-salon/admin/settings';
