    ...
    <section id="location" className="py-16 sm:py-20 bg-stone-950 border-b border-stone-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="text-xs font-bold text-amber-400 tracking-widest uppercase mb-2 block font-mono">
            Location & Contact
          </span>
          <h2 className="text-3xl sm:text-4xl font-extrabold font-display text-stone-100">
            Find Afroza Gents Salon
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 bg-stone-900 rounded-2xl border border-stone-800 p-6 sm:p-8 flex flex-col justify-between shadow-xl">
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={`tel:${config.phone.replace(/\s+/g, '')}`} className="text-sm text-amber-400 font-bold hover:underline block mt-0.5">
                    {config.phone}
                  </a>
                  <a
                    href={`https://wa.me/${config.whatsappRaw}?text=Hello%20Afroza%20Gents%20Salon%2C%20I%20need%20directions%20to%20your%20salon.`}
                    target="_blank"
            ...
            <div className="pt-8 border-t border-stone-800 space-y-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold py-3.5 rounded-xl text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-md"
              >
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <a
                  href={`https://wa.me/${config.whatsappRaw}?text=Hello%20Afroza%20Gents%20Salon%2C%20I%20would%20like%20to%20ask%20a%20question.`}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="lg:col-span-7 bg-stone-900 rounded-2xl border border-stone-800 overflow-hidden relative min-h-[380px] flex flex-col justify-between p-6">
            ...
            <div className="absolute inset-0 bg-stone-950">
              <iframe
                title="Afroza Gents Salon Location Map"
