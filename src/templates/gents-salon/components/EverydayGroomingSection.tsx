      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {everydayServices.map((service) => (
            <div
              key={service.id}
              className="bg-stone-950 rounded-2xl border border-stone-800 p-5 flex flex-col justify-between hover:border-amber-500/40 transition-all group"
            >
              <div>
              ...
              <div className="pt-3 border-t border-stone-900 flex items-center gap-2">
                ...
                <button
                  ...
                  className="bg-amber-500 hover:bg-amber-400 text-stone-950 text-xs py-2 px-3 rounded-lg font-bold flex items-center gap-1 transition-colors"
                >
