    ...
    <header className="sticky top-[33px] z-30 bg-stone-900/95 backdrop-blur-md border-b border-stone-800 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            <div className="w-10 h-10 rounded-lg bg-stone-800 border border-amber-500/30 flex items-center justify-center text-amber-400 group-hover:border-amber-400 group-hover:bg-stone-700/80 transition-all shadow-md">
            ...
            <div>
              ...
              <span className="text-[10px] text-amber-400/90 tracking-widest uppercase font-medium block">
                {config.tagline}
              </span>
            </div>
          </button>
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium border transition-all ${
                isPwaInstalled
                  ...
                  : 'bg-stone-800 text-stone-200 border-stone-700 hover:border-amber-500/50 hover:text-amber-400'
              }`}
            >
              {isPwaInstalled ? (
                <>
            ...
            <button
              ...
              className="bg-bronze-gradient text-stone-950 font-semibold px-4 py-2.5 rounded-lg text-xs sm:text-sm tracking-wide uppercase shadow-lg shadow-amber-900/20 hover:brightness-110 active:scale-95 transition-all flex items-center gap-2"
            >
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <button
              ...
              className="p-2 rounded-lg bg-stone-800 text-stone-200 hover:text-amber-400 border border-stone-700 focus:outline-none"
