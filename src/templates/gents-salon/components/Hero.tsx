  ...
  return (
    <section className="relative min-h-[85vh] lg:min-h-[90vh] flex items-center justify-center overflow-hidden bg-stone-950 py-16 lg:py-24">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={IMAGES.hero}
          alt="Afroza Gents Salon International City Dubai"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl space-y-6">
          ...
          {/* Eyebrow badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-stone-900/90 border border-amber-500/30 text-amber-400 text-xs font-semibold tracking-wider uppercase backdrop-blur-md">
          ...
          <p className="text-sm sm:text-base text-stone-300 max-w-2xl leading-relaxed">
            From everyday haircuts and beard grooming to a clean, complete grooming experience — visit Afroza Gents Salon for professional men's grooming in Dubai.
          </p>
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3 sm:gap-4">
            <button
              ...
              className="bg-bronze-gradient text-stone-950 font-bold px-6 py-3.5 rounded-xl text-sm uppercase tracking-wider shadow-xl shadow-amber-900/20 hover:brightness-110 active:scale-95 transition-all flex items-center gap-2"
            >
            ...
            <a
              href={`https://wa.me/${config.whatsappRaw}?text=Hello%20Afroza%20Gents%20Salon%2C%20I%20would%20like%20to%20book%20an%20appointment.`}
              target="_blank"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-stone-900/90 hover:bg-stone-800 text-stone-100 font-semibold px-5 py-3.5 rounded-xl text-sm uppercase tracking-wider border border-stone-700 hover:border-amber-500/50 backdrop-blur-md transition-all flex items-center gap-2"
            >
