    ...
    <section className="py-20 bg-stone-950 relative overflow-hidden border-b border-stone-800">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-semibold uppercase tracking-wider mb-2">
          ...
          <button
            ...
            className="text-amber-400 hover:text-amber-300 text-sm font-semibold flex items-center gap-1.5 shrink-0 hover:underline"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {premiumServices.map((service) => (
            <div
              key={service.id}
              className="bg-stone-900/90 rounded-2xl border border-stone-800 hover:border-amber-500/50 overflow-hidden transition-all duration-300 flex flex-col justify-between group shadow-xl"
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-3 right-3 bg-stone-950/90 backdrop-blur-md border border-amber-500/40 px-2.5 py-1 rounded-full text-xs font-bold text-amber-400">
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-heading font-bold text-stone-100 text-base group-hover:text-amber-400 transition-colors mb-2">
                    {service.name}
                  </h3>
                ...
                <div className="space-y-3 pt-3 border-t border-stone-800">
                  <button
                    ...
                    className="w-full text-center text-xs text-amber-400 hover:underline font-medium"
                  >
